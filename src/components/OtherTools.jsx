  ...
  const tools = [
    {
      ...
      link: "https://removerio.vercel.app",
      status: "live",
      icon: FaMagic,
    ...
    },
    {
      ...
      name: "Code Formatter",
      description:
        "Automatically format and beautify your code in multiple languages",
      link: "#",
      status: "coming-soon",
      icon: FaRocket,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Discover more powerful tools designed to streamline your workflow
          ...
          {tools.map((tool, index) => {
            ...
            return (
              ...
              >
                {/* Card */}
                <div
                  className={`relative bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border-2 border-gray-700/50 group-hover:border-gray-500/50 transition-all duration-300 h-full flex flex-col ${
                ...
                >
                  ...
                  >
                    <span>{isLive ? "Visit Tool" : "Coming Soon"}</span>
                    {isLive && (
                      <motion.div
                        animate={{ x: [0, 4, 0] }}
                ...
                {/* Glow effect */}
                <div
                  className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${tool.color} opacity-0 group-hover:opacity-10 blur-xl transition-opacity duration-500 -z-10`}
                />
              </motion.div>
            );
          })}
