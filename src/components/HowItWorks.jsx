      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-black px-8 py-4 rounded-xl font-bold text-lg inline-flex items-center gap-3 cursor-pointer shadow-2xl hover:shadow-yellow-500/25 transition-all duration-300"
